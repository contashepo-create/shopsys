...
- F9 لحفظ المسودة فقط، وF8 للاعتماد/الترحيل خارج الكاشير؛ داخل الكاشير يبقيان للتحصيل والدفع حسب السياق.
- ترتيب الأزرار: طباعة F6، حفظ مسودة F9، اعتماد/ترحيل F8، مع شارات الاختصار داخل الأزرار في الرأس والشريط السفلي.
- المعالج النصي يعمم الاختصار على محررات الأنشطة التي تستخدم أزرار «حفظ مسودة» و«اعتماد/ترحيل»، واختبار مباشر يمنع F9 من ترحيل الفاتورة.
