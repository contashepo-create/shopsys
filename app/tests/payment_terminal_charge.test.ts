...
describe('مصنع تحصيل الماكينة', () => {
  ...
  it('يجعل مرجع المزود اختيارياً ويرفض المبلغ غير الصالح', () => {
    const withoutReference = buildTerminalCharge({ terminal, documentType: 'rental', documentId: 1, amountMinor: 1000, providerReference: '', occurredAt: '2026-09-22T10:00:00Z', userId: 3 })
    expect(withoutReference.providerReference).toMatch(/^AUTO-/)
    expect(() => buildTerminalCharge({ terminal, documentType: 'rental', documentId: 2, amountMinor: 0, providerReference: '', occurredAt: '2026-09-22T10:00:00Z', userId: 3 })).toThrow()
  })
})
