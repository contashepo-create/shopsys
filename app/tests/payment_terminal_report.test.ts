...
import { summarizeTerminalActivities, summarizeTerminalReconciliation, summarizeTerminalTransactions, terminalReportCsv } from '../src/core/paymentTerminalReport.ts'
...
describe('تقرير ماكينة الدفع', () => {
 it('يلخص حسب النشاط مع توافق البيع القديم', () => expect(summarizeTerminalActivities([{ ...make('p1', 'charge', 1000), documentType: 'logistics_trip' }, make('p2', 'charge', 500)])).toMatchObject([{ documentType: 'logistics_trip', chargeMinor: 1000 }, { documentType: 'sale', chargeMinor: 500 }]))
