...
export function Dashboard() {
  ...
  const { journal, sales, items, purchases } = useDataStore()
  ...
  const todayRevenue = todaySales.reduce((a, s) => a + s.totals.totalMinor, 0)
  const todayProfit = todaySales.reduce((a, s) => a + (s.totals.taxBaseMinor - s.totals.cogsMinor), 0)
