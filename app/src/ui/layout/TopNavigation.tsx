...
export function TopNavigation() {
  ...
  return <nav className="sticky top-0 z-50 flex items-center gap-1 px-3 py-2 border-b bg-white dark:bg-slate-950 flex-wrap shadow-sm" onMouseLeave={()=>setOpen(null)}>
