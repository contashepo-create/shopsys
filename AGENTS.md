...
- **EPT-44 إيجار العقارات — جزئي (2026-09-22):** `collectLeaseInstallment` يدعم في Repository تحصيل الماكينة وحسابها والصلاحية والحد ومنع المرجع المكرر، ويحفظ القسط والقيد وحركة `rental` في تحديث واحد. **المرحلة غير مكتملة** لأن `RealEstatePages.tsx` لم يُربط بعد بالمكوّن ولم يُختبر المسار من الواجهة.
