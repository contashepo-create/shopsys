...
export type TerminalDocumentType = 'sale' | 'sale_return' | 'restaurant_order' | 'logistics_trip' | 'project_extract' | 'client_collection' | 'installment' | 'rental' | 'clinic' | 'lab' | 'insurance_claim' | 'maintenance' | 'laundry' | 'wallet_service' | 'car_sale' | 'external_commission' | 'receipt_voucher' | 'other'
