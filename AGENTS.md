...
- **ADV-INV-58 (2026-09-23):** فاتورة الشراء المتقدمة تدعم «مشتريات نقدية بدون مورد محدد» بشرط السداد الكامل، وتربطها داخلياً بمورد نقدي افتراضي للحفاظ على سلامة القيود والتقارير دون إجبار المستخدم على إنشاء مورد يدوي.
...
- تحتفظ النافذة بالتفاصيل المحاسبية: القيمة، الضريبة ونسبتها، التسوية، الخزينة أو حساب الاستحقاق، حساب المصروف، تأثيره على الربحية، `landedCostAllocation`، ومركز التكلفة العام (`projectId`)؛ كما يبقى مركز تكلفة مركبة الأسطول في مصروف الشراء.
