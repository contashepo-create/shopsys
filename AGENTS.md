...
- اكتملت مراجعة العمليات التشغيلية المنفردة: الشيكات، العهد، الاستبدال، ذهب الكسر والمقايضة، زيارة العيادة، تقسيم أمر المطعم، تسوية الماكينات، الورديات، قيد اليومية، السيارات، المعدات، المختبر، وخطابات الضمان/سجلات عمال اليومية تعرض F9 على زر التنفيذ؛ أزرار البيانات الأساسية وأفعال الصفوف المتعددة لا تُوسم عشوائياً لتفادي تنفيذ أول صف بالخطأ.
- أضيفت دلالة `role="dialog"` للنوافذ الموحدة، ويقصر F8/F9 البحث على النافذة العليا المفتوحة حتى لا يفوز زر من الصفحة الخلفية أثناء إدخال عملية.
