...
- العميل والمورد ليسا قائمة منسدلة: الحقل مربع كتابة حر، وعند الكتابة/التركيز يفتح بحثاً منبثقاً حقيقياً بالاسم أو الكود الفريد، وتعرض النتيجة الاسم والكود والرصيد، وتعرض «موقوف» فقط عند `active === false`.
