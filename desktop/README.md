...
- عقد outbox عبر IPC يدعم الإدراج الفريد، المطالبة الذرية، وإكمال الحدث بنجاح أو فشل مع إعادة محاولة مؤجلة. لا يوجد مستهلك مزامنة بعد؛ لا تُعد هذه المرحلة مزامنة سحابية.
