...
for (const activityId of ACTIVITIES) {
  ...
  mem.clear()
  mem.set('shopsys-app', JSON.stringify({ state: { setup: { requireOpenShiftForSales: false,  done: true, countryCode: 'EG', activityId, vatPercent: 14, taxInclusive: false, allowNegativeTreasury: false }, license: { plan: 'pro' } }, version: 0 }))
