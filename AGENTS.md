...
- ⏳ متبقٍ من دفعة الـ25: أمر 6 (إضافة صنف سريع داخل الفاتورة — أُنجز جزئياً داخل مودال التعديل)، 8 (اختيار المخزن أعلى الفاتورة + «مخزن غير محدد» + افتراضي بالإعدادات)، 13 (كارت الصنف: بيانات إضافية + دفتر حركة الصنف بفلتر وطباعة)، 22 (مراجعة محاسبة الأقساط)، 23 (رفع الصيانة لمستوى mobileshop)، 24 (خدمات المحافظ الإلكترونية — ربح = مبلغ المكينة − المحصل).
