...
- أضيف كروم بصري موحد لمحرري البيع والشراء عبر `InvoiceReferenceChrome`: بيانات المسودة والتاريخ والحالة والعملة والمستودع والطرف، شريط اختصارات عملي لـF2/F5/F6/F8/F9، وحالة اتصال واضحة. الأزرار تستدعي callbacks الصفحة الفعلية ولا تكرر منطق الترحيل.
