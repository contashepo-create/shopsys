  ...
  return (
    <MainLayout title={title}>
      <Routes>
        ...
        <Route path="/inventory/items" element={<ComingSoon title="الأصناف (بنظام الخصائص المرنة)" phase="المرحلة 1" />} />
        <Route path="/inventory/warehouses" element={<ComingSoon title="المخازن" phase="المرحلة 1" />} />
        ...
        <Route path="/purchases/suppliers" element={<ComingSoon title="الموردون" phase="المرحلة 1" />} />
        <Route path="/parties/customers" element={<ComingSoon title="العملاء" phase="المرحلة 1" />} />
        ...
        <Route path="/settings/general" element={<ComingSoon title="الإعدادات العامة" phase="المرحلة 1" />} />
...
export default function App() {
  ...
  return <HashRouter>{setup.completed ? <Shell /> : <FirstRunWizard />}</HashRouter>
}
