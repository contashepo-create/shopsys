...
- عرض القائمة هو الافتراضي في شاشات الأطراف، ويحفظ تبديل بطاقات/قائمة بمفتاح مستقل لكل قسم (`customers` و`suppliers`) في التخزين المحلي؛ لا تُسجل تفضيلات العرض داخل دفتر الأعمال أو الحالة المحاسبية.
